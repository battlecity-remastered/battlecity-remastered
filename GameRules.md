...
- Mines detonate when an opposing-city tank overlaps their tile, dealing `DAMAGE_MINE` (35) and clearing the mine from the field while leaving allies unaffected. This leaves the victim with exactly 5 HP remaining—one laser shot away from death. (client/src/collision/collision-helpers.js:54, client/src/play.js:11)
